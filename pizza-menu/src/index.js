...
function Footer() {
  ...
  return <footer className='footer'>
    {isOpen ? <Order openHour={openHour} closeHour={closeHour} /> : <Close openHour={openHour} closeHour={closeHour} />}
  </footer>
}
...
function Order({openHour ,closeHour}) {
  ...
  <p>
    We're open from {openHour}:00 until {closeHour}:00. Come to visit us or order online.
  </p>
